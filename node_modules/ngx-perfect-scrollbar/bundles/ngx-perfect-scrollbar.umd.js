(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/Subject'), require('rxjs/operators'), require('@angular/core'), require('perfect-scrollbar'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define(['exports', 'rxjs/Subject', 'rxjs/operators', '@angular/core', 'perfect-scrollbar', '@angular/common'], factory) :
	(factory((global.zef = global.zef || {}, global.zef.ngxPerfectScrollbar = {}),global.Rx,global.Rx.Observable.prototype,global.ng.core,global.PerfectScrollbar,global.ng.common));
}(this, (function (exports,Subject,operators,core,PerfectScrollbar,common) { 'use strict';
...
var PerfectScrollbarDirective = (function () {
    ...
    PerfectScrollbarDirective.propDecorators = {
        ...
        "psScrollDown": [{ type: core.HostListener, args: ['ps-scroll-down', ['$event'],] },],
...
var PerfectScrollbarComponent = (function () {
    function PerfectScrollbarComponent(cdRef, elementRef) {
        ...
        this.stateUpdate = new Subject.Subject();
        this.disabled = false;
    ...
    function () {
        ...
        this.stateSub = this.stateUpdate
            .pipe(operators.distinctUntilChanged(function (a, b) { return (a === b && !_this.stateTimeout); }))
