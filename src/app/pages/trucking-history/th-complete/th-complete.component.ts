...
@Component({
    selector: 'app-th-complete',
    templateUrl: './th-complete.component.html',
    styleUrls: ['./th-complete.component.css']
})
export class ThCompleteComponent implements OnInit {
    public week_list: any[];
    public history_years: any[];
